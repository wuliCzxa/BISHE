...
num = 0
# 图片与标签json的文件夹路径
files_path = r"mydata_visualization_p"
...
for file in os.listdir(files_path):
    if file.endswith(".jpg"):
        ...
        # 关键点配色
        kpt_color_map = {
            'p1': {'id': 0, 'color': [255, 0, 0], 'radius': 3, 'thickness': -1},
            'p2': {'id': 1, 'color': [0, 255, 0], 'radius': 3, 'thickness': -1}
        }
        ...
        # plt.show()
        # 当前目录下保存可视化结果
        cv2.imwrite(f'visualization_result_p/{num}.jpg', img_bgr)
        num += 1
print('=========================ok========================')