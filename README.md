...
>
> 主要支持 **Web 浏览器端**、**PyQt5 桌面端**、**批量脚本** 三种使用方式，可一键完成表盘定位→标签识别→刻度检测→数值计算的完整读数流程，并提供历史记录查询与多日期趋势图功能。
...
- [四、数据库表结构](#四数据库表结构)
- [五、环境要求](#五环境要求)
- [六、ngrok部署（内网穿透）](#六ngrok部署内网穿透)
- [七、完整部署流程（新手必读）](#七完整部署流程新手必读)
- [八、各功能模块详细使用说明](#八各功能模块详细使用说明)
- [九、模型训练完整流程开发者](#九模型训练完整流程开发者)
- [十、核心读数算法详解](#十核心读数算法详解)
- [十一、API 接口说明](#十一api-接口说明)
- [十二、用户权限体系](#十二用户权限体系)
- [十三、输出文件说明](#十三输出文件说明)
- [十四、常见问题与排错指南](#十四常见问题与排错指南)
- [十五、注意事项与已知限制](#十五注意事项与已知限制)
---
...
<img width="1024" height="559" alt="系统架构图002" src="https://github.com/user-attachments/assets/17dca884-13d8-49da-9a96-8800221fb15a" />
...
`序号标记对照表.xlsx` 用于将 Model 4 从标签图上识别出的**数字序号**（1\~52）映射为**有意义的表计名称**（如"220kv 白远一线2252"）。
...
<img width="665" height="239" alt="image" src="https://github.com/user-attachments/assets/0d2b20a0-334b-465f-af2e-f6163116332a" />
...
| 图片名称 | 表计 | 最终读数 | 检测时间 |
|---------|------|---------|---------|
| a(31) | 220kv 白远一线2252 | 0.532362 | 2025-07-20 |
